...
async function displaySongs() {
    ...
    Array.from(document.getElementsByClassName("card")).forEach(e => { 
        e.addEventListener("click", async item => {
            ...
            songs = await getSongs(`Tutorial%2084%20-%20SPOTIFY%20Clone/My%20Solution/songs/${item.currentTarget.dataset.folder}`)
        })
    })
}
...
async function main() {
    ...
    await getSongs("Tutorial%2084%20-%20SPOTIFY%20Clone/My%20Solution/songs/Folder1")
